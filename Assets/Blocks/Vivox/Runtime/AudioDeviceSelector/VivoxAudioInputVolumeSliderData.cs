...
{
    public class VivoxAudioInputVolumeSliderData : IDisposable, INotifyBindablePropertyChanged
    {
        ...
        public float VolumeValue
        {
            ...
            set
            {
                ...
                m_VivoxObserver.VivoxService.SetInputDeviceVolume(SliderToVivox(value));
                m_VolumeValue = value;
                Notify();
            }
        }

        public VivoxAudioInputVolumeSliderData()
        {
        ...
        void OnVivoxReady()
        {
            m_VolumeValue = VivoxToSlider(m_VivoxObserver.VivoxService.InputDeviceVolume);
